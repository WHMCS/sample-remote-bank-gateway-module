...
$bankToken = isset($_POST['bank_token']) ? $_POST['bank_token'] : '';
...
<form method="post" action="submit-handler.php" style="margin:0 auto;width:80%;">
    ...
    <input type="hidden" name="bank_token" value="<?= $bankToken ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" name="bank_routing" class="form-control" required>
    </div>
    <div class="form-group">
